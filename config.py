...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Akramabdallh/AMusic",
)
...
CHANNEL_NAME = getenv("CHANNEL_NAME", "𝚂𝚄𝙾𝚁𝙲𝙴 𝙺imo")
CHANNEL_LINK = getenv("CHANNEL_LINK", "KM_I9")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/GIY_19")
